<%@ Page Title="Home" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LMS._Default" %>
                                ...
                                <div class="wrap">
                                    <div class="container">
                                        <div class="form-group">
                                            <asp:Label ID="lbl_searchbox" runat="server" Text="Search for" CssClass="lead text-uppercase"></asp:Label>
                                            <asp:TextBox ID="tbx_searchbox" runat="server" CssClass="form-control form-control-lg"
                                                placeholder="Percy Jackson, Fiction, Biography..."></asp:TextBox>
                                        </div>
                                        <div class="form-inline">
                                            <div class="form-group">
                                                <asp:Label ID="Label3" runat="server" Text="Limit search to:" CssClass="mr-1 text-uppercase lea"></asp:Label>
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-sm-6 ">
                        <div class="row">
                            <div class="col col-sm-6">
                                <ul class="bullet-less">
                                    <li style="border: 0; padding: 0;">
                                        <h4 style="color: black;"><strong>Quick Links</strong></h4>
                                    </li>
                                    <li><a href="#">Hours</a></li>
                                    <li><a href="#">Visiting</a> </li>
                                    <li style="border-bottom: 0;"><a href="#">Computing</a></li>
                                </ul>
                            </div>
                            <div class="col col-sm-6">
                                <ul class="bullet-less">
                                    <li style="border: 0; padding: 0;">
                                        <h4 style="color: black;"><strong>Explore</strong></h4>
                                    </li>
                                    <li><a href="#">Research Guides</a></li>
                                    <li><a href="#">Research Services</a> </li>
                                    <li style="border-bottom: 0;"><a href="#">Special Collections, Archives, & Avery Fisher Center</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="col col-sm-12">
                                <ul class="bullet-less">
                                    <li style="border: 0; padding: 0;">
                                        <h4 style="color: black;"><strong>Rooms & Spaces</strong></h4>
                                    </li>
                                    <li>
                    ...
                    <div class="col-6 col-sm-6 align-self-start w-100">
                        <h4 style="color: black;"><strong>Explore Our Resources</strong></h4>
                        <div class="row">
                ...
                <div class="row" style="padding-top: 20px;">
                    <div class="col col-sm-6">
                        <ul class="bullet-less-content">
                            <li style="border: 0; padding: 0;">
                                <h4 style="color: black;"><strong>Library News & Updates</strong></h4>
                            </li>
                            <li>
                    ...
                    <div class="col col-sm-6">
                        <ul class="bullet-less-content">
                            <li style="border: 0; padding: 0;">
                                <h4 style="color: black;"><strong>Library Classes</strong></h4>
                            </li>
                            <li>
